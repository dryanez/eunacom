        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{
              ...
              Preparación integral para médicos nacionales y extranjeros. 86 clases grabadas del perfil oficial ASOFAMECH, banco de 4.000+ preguntas comentadas, reconstrucciones de las pruebas desde 2013 y tutoría médica individualizada.
            </p>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <CheckCircle2 size={18} color="#a9d3f5" />
                <span>Reconstrucciones desde 2013</span>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <CheckCircle2 size={18} color="#a9d3f5" />
                <span>Tutoría con Equipo académico</span>
              </div>
            </div>
          </div>
