    ...
    return (
        <aside className={`sidebar ${mobileOpen ? 'open' : ''}`}>
            ...
            <div className="sidebar__footer">
                {!isPremium && !isAdmin() && !loadingPremium && !authLoading && user && (
                    <div style={{ marginBottom: '0.65rem', padding: '0.65rem 0.75rem', background: 'rgba(255,255,255,0.05)', borderRadius: '10px', border: '1px solid rgba(255,255,255,0.1)' }}>
                        ...
                        <button 
                            ...
                            style={{ 
                                ...
                                fontSize: '0.78rem', fontWeight: 800, border: 'none', cursor: 'pointer', boxShadow: '0 2px 8px rgba(6,182,212,0.3)', minHeight: '36px'
                            }}
                        >
