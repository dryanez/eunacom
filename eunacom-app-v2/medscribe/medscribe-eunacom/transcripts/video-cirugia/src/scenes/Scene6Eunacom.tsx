...
const OPTIONS = [
  { letter: "A", text: "Infeccion de herida operatoria" },
  { letter: "B", text: "Atelectasia pulmonar" },
  { letter: "C", text: "Trombosis venosa profunda" },
  { letter: "D", text: "Reaccion adversa a medicamentos" },
];
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: THEME.bg }}>
      ...
      >
        ...
        >
          Paciente de 58 anos, post{" "}
          <span style={{ fontWeight: 700, color: THEME.accentLight }}>
            colecistectomia laparoscopica
          </span>{" "}
          hace 6 horas. Presenta fiebre 38.5 C, crepitaciones bilaterales.
          Herida operatoria limpia, sin signos de infeccion.{" "}
          <span style={{ fontWeight: 700, color: THEME.accentLight }}>
        ...
        {isRevealed && (
          ...
          >
            ...
            >
              Fiebre &lt;24h postoperatoria con crepitaciones bilaterales y herida limpia.{" "}
              <span style={{ color: THEME.success, fontWeight: 600 }}>
                Atelectasia pulmonar
              </span>{" "}
              es la causa mas frecuente de fiebre postoperatoria precoz.
            </div>
          </div>
        )}
      </AbsoluteFill>
