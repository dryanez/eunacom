...
export const FAQ = [
  ...
  {q:"¿El curso incluye preparación para el EUNACOM práctico?",a:"No. Nuestros cursos preparan exclusivamente el EUNACOM teórico (EUNACOM-ST). El examen práctico se rinde por separado ante las universidades y no ofrecemos preparación para esa sección."},
